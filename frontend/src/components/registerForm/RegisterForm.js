        ...
        <>
            <form className="login" onSubmit={(e) => {
                ...
                <Controller
                    name="login"
                    control={control}
                    rules={{required: "Обязательное поле", minLength: {
                        value: 4,
                    ...
                    rules={{required: true, 
                        pattern: {
                            ...
                            message: "Your password must include minimum 8 letters and one number"
                        } }}
                    render={({field}) => {
                        return(
                            <TextField 
            ...
            <span className="login__register">Already have an account? <a href="#">Login</a> </span>
            </form>
        </>
